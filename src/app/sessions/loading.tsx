/** Skeleton rows while the day loads — avoids a blank flash on the default view. */
    ...
    <main>
      <div style={{ padding: '14px 18px 0', display: 'flex', justifyContent: 'space-between' }}>
        <div className="view-toggle" style={{ opacity: 0.4 }}>
          <span className="view-toggle-tab" data-active="true">Day</span>
          <span className="view-toggle-tab" data-active="false">Week</span>
